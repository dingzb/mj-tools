...
class Ui_self(QtGui.QMainWindow):
    def __init__(self):
    ...
    def retranslateUi(self):
        ...
        self.pushButton.setText(_translate("self", "PushButton", None))
        self.pushButton_2.setText(_translate("self", "PushButton", None))
        self.pushButton_3.setText(_translate("self", "PushButton", None))
        self.menuConnections.setTitle(_translate("self", "Connections", None))
        self.toolBar.setWindowTitle(_translate("self", "toolBar", None))
        self.actionNew.setText(_translate("self", "New", None))
        self.actionConnection.setText(_translate("self", "connection", None))
